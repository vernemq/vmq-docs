...
{% hint style="info" %}
There is a include conf.d/*.conf at the end the vernemq.conf file. VerneMQ is not actually reading from conf.d/*.conf. The include can be ignored, and no configurations shall be made there. 
{% endhint %}
